function [ dydt , L_Z, L_Y, d2Zdx2, Fluxes] = odefun_Kathiedit( t, y , mybeta, Diff_type, D)
...
[L_Z, L_V, L_Y, Fluxes] = calc_Kathiedit(Z, V, Y, mybeta);
...
mygamma = 1970; % Koingberg 2005 [mV/muM]
dZdt = d2Zdx2 +L_Z;
dVdt = mygamma*(d2Zdx2 +L_V);
dYdt = L_Y;
