...
% File does the spatial coupling and the diffusion calculation 
% File format input/output to confine with the inbuilt ode solver 
% Imputs: t = time is a single point as the solver is running
%         y = the solution at current time a vector of length 3*(length(mybeta))
%         mybeta = beta profile used to calculate stuff
%         D = Diffusion coefficient 
%         Diff_type = 1 for zero or fickian diffusion OR 2 for electro
%                      diffusion
% Outputs:  dydt = rate of change vector for ode solver
%           All others are if you want to plot other stuff later on
% Author: Michelle Goodman
% Date Last Edit: 7/11/17
...
%% Calculate Reaction part of equation
[L_Z, L_V, L_Y, v_2, v_3] = calc_Gold(Z, V, Y, mybeta); %%%%%%%%%%%%%%%%%%%%%%% The line you care about
