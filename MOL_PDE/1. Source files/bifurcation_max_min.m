...
subplot(1,3,1)
        ...
        plot([t(1), t(end)], [pointsfound1(2,2), pointsfound1(2,2)],  'k','LineWidth',2)
...
subplot(1,3,2)
        ...
        plot([t(1), t(end)], [pointsfound2(2,2), pointsfound2(2,2)],  'g','LineWidth',2)
        
        
%% Minimum Bifurcation
[ minpointsfound ] = Min_Bifurcation_points( x,t,ZFD);
figure(2)
subplot(1,3,2)
...
I =  find(x>pointsfound1(2,1), 1); J =  find(x>pointsfound1(2,2), 1);
plot([pointsfound1(2,1), pointsfound1(2,1)],[0, max_line(I-1)], 'k','LineWidth',2)
plot([pointsfound1(2,2), pointsfound1(2,2)],[0, max_line(J-1)], 'k','LineWidth',2)
...
I =  find(x>pointsfound2(2,1), 1); J =  find(x>pointsfound2(2,2), 1);
plot([pointsfound2(2,1), pointsfound2(2,1)],[0, max_line(I-1)], 'g','LineWidth',2)
plot([pointsfound2(2,2), pointsfound2(2,2)],[0, max_line(J-1)], 'g','LineWidth',2)
