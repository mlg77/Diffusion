...
%% Run Simulation 0D
    ...
    save('DataPDE', 'Z0D','Y0D', 'A0D', 'V0D', 't', 'x', 'mybeta', 'runtime')
...
for ii = 1:4
    ...
    cd([dir_save, dir_name]) 
    save(['DataPDE', num2str(ii)], 'Z','Y', 'A', 'V', 't', 'x', 'mybeta', 'runtime', 'D')
...
for ii = 1:4
    ...
    cd([dir_save, dir_name]) 
    save(['DataPDE', num2str(ii+4)], 'Z','Y', 'A', 'V', 't', 'x', 'mybeta', 'runtime', 'D')
