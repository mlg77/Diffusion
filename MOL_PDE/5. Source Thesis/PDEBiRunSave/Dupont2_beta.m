...
%% Run Simulation 0D
    ...
    save('DataPDE990', 'Z0D','Y0D', 'A0D', 'V0D', 't', 'x', 'mybeta', 'runtime')
...
for ii = 1
    ...
    cd([dir_save, dir_name]) 
    save(['DataPDE', num2str(99)], 'Z','Y', 'A', 'V', 't', 'x', 'mybeta', 'runtime', 'D')
...
for ii = 1:NumberOfFig
    savefig(ii, [num2str(97+ii), 'DataPDE.fig'])
end
...
for i = 1:NumberOfFig
    ...
    print([num2str(97+i),'DataPDE'],'-dpng', '-r300')
end
