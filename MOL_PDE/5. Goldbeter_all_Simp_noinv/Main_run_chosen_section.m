...
cd('C:\Users\mlg77\Local Documents\Git\Diffusion\MOL_PDE\5. Goldbeter_all_Simp_noinv\Pervious_saves')
%% Do first section
if strcmp(mystr, 'bounds') | strcmp(mystr, 'all')
    load('inital_data.mat');
    cd('C:\Users\mlg77\Local Documents\Git\Diffusion\MOL_PDE\5. Goldbeter_all_Simp_noinv')
...
if strcmp(mystr, 'ED') | strcmp(mystr, 'all')
    ...
    Z_0 = 0.3; V_0 = -40; Y_0 = 0.5;
    D = 6e-6;
    dt = 2e-3; t_end = 40; t = 0:dt:t_end;   N = length(t);
    dx = 1e-3; x = 0:dx:1;   M = length(x); 
    mybeta = (0.5*(1+tanh((x-0.5)/0.5)))';
