...
cd('C:\Users\mlg77\Local Documents\Git\Diffusion\MOL_PDE\5a. Goldbeter_all_Simp_DV\Pervious_saves')
%% Do first section
if strcmp(mystr, 'bounds') | strcmp(mystr, 'all')
    load('inital_data.mat');
    cd('C:\Users\mlg77\Local Documents\Git\Diffusion\MOL_PDE\5a. Goldbeter_all_Simp_DV')
...
if strcmp(mystr, 'simple') | strcmp(mystr, 'all')
    ...
    dt = 1; t_end = 5; t = 0:dt:t_end;   N = length(t);
    dx = 0.5; x = 0:dx:1;   M = length(x); 
...
if strcmp(mystr, 'SD') | strcmp(mystr, 'all')
    ...
    Z_0 = 0.3; V_0 = -40; Y_0 = 0.5;
    D = 200e-6;
    dt = 1e-3; t_end = 20; t = 0:dt:t_end;   N = length(t);
    dx = 0.5e-3; x = 0.2:dx:0.8;   M = length(x); 
...
if strcmp(mystr, 'ED') | strcmp(mystr, 'all')
    ...
    Z_0 = 0.3; V_0 = -40; Y_0 = 0.5;
    D = 60e-6;
    dt = 50e-3; t_end = 100; t = 0:dt:t_end;   N = length(t);
    dx = 2e-3; x = 0:dx:1;   M = length(x); 
    mybeta = (0.5*(1+tanh((x-0.5)/0.3)))';
